...
export const seedIssues: Issue[] = [
  ...
  },
  {
    ...
    body: "The registry stores widget instances globally, which causes test pollution and makes SSR integration unreliable. This needs a compatibility plan.",
    state: "open",
    labels: ["refactor", "stale"],
    assignees: [],
    createdAt: "2025-11-14T08:45:00.000Z",
    updatedAt: "2026-01-12T10:22:00.000Z",
    closedAt: null,
    lastCommentAt: "2026-01-12T10:22:00.000Z",
    firstResponseHours: 216,
    isStale: true,
    difficulty: "hard",
    metrics: {
      bodyWordCount: 121,
