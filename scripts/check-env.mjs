...
const optional = ["GEMINI_API_KEY", "OPENAI_API_KEY", "GITHUB_TOKEN", "GITHUB_INGEST_REPOS", "RESEND_API_KEY", "RESEND_FROM_EMAIL", "SLACK_WEBHOOK_URL", "CRON_SECRET", "SENTRY_DSN", "OPS_API_KEY"];
